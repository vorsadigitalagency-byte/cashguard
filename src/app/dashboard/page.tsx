  ...
  return (
    <div className="fixed inset-0 bg-black/70 z-40 flex items-end justify-center p-4">
      <div className="w-full max-w-md bg-[#1A1A2E] rounded-3xl p-6 border border-gray-700">
        <h3 className="text-white text-lg font-black uppercase mb-1">Shift Shuru Karo</h3>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button onClick={onCancel} className="py-3 rounded-2xl bg-gray-800 text-gray-400 font-bold uppercase">
            Cancel
          </button>
          <button
    ...
    <div className="min-h-screen bg-[#0A0A0F] text-white pb-24">
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <button onClick={signOut} className="text-gray-600 text-sm uppercase tracking-wider py-2">
            Logout
          </button>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#1A1A2E] border-t border-gray-800 flex justify-around py-3 px-4">
        ...
        <button onClick={() => router.push("/profile")} className="flex flex-col items-center gap-1">
          <span className="text-gray-500 text-xl">Profile</span>
        </button>
      </div>
    </div>
  );
